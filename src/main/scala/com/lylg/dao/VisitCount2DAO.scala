...
import com.lylg.Bean.VisitCount
...
/**
 * Description: 数据访问层：用于浏览量的数据保存
 */
object VisitCount2DAO {
  val tableName = "lylg_visit"
  val cf = "info"
  val qualifer = "distinct"
  ...
  def main(args: Array[String]): Unit = {
    ...
    list.append(VisitCount("2022-07-08", 8))

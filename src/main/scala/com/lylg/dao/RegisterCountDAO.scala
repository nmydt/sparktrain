...
import com.lylg.Bean.RegisterCount
 ...
 */
object RegisterCountDAO {
  val tableName = "lylg_register"
  val cf = "info"
  val qualifer = "count"
  ...
  def main(args: Array[String]): Unit = {
    ...
    list.append(RegisterCount("2022-07-08", 8))
   ...
   */
  def save(list: ListBuffer[RegisterCount]): Unit = {

...
import com.lylg.Bean.TotalCount
 ...
 */
object TotalCountDAO {
  val tableName = "lylg_total"
  val cf = "info"
  val qualifer = "count"
  ...
  def main(args: Array[String]): Unit = {
    ...
    list.append(TotalCount("2022-07-08", 8))
   ...
   */
  def save(list: ListBuffer[TotalCount]): Unit = {

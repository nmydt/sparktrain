...
import com.lylg.Bean.ActiveCount
 ...
 */
object ActiveCountDAO {
  val tableName = "lylg_active"
  val cf = "info"
  val qualifer = "count"
  ...
  def main(args: Array[String]): Unit = {
    ...
    list.append(ActiveCount("2022-07-08", 8))
   ...
   */
  def save(list: ListBuffer[ActiveCount]): Unit = {
